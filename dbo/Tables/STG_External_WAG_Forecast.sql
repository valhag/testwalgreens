CREATE TABLE [dbo].[STG_External_WAG_Forecast] (
    [row_number]     INT            NULL,
...
GO
CREATE NONCLUSTERED INDEX [ix_STG_External_WAG_Forecast_dt_filename]
    ON [dbo].[STG_External_WAG_Forecast]([dt_filename] ASC);
